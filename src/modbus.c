...
static uint8_t compute_meta_length_after_function(modbus_t *ctx, int function, modbus_msg_type_t msg_type)
{
    int length;
...
static int
compute_data_length_after_meta(modbus_t *ctx, uint8_t *msg, modbus_msg_type_t msg_type)
{
